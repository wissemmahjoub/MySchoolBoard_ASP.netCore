...
namespace EFCoreToDo.Migrations
{
    ...
    [Migration("20170307142935_chams3")]
    partial class chams3
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("EFCoreToDo.Models.Classs", b =>
                {
                    ...
                    b.Property<string>("ClassNamee");

                    b.Property<int>("NbreEtudiants");

                    b.Property<string>("Niveaux");
            ...
            modelBuilder.Entity("EFCoreToDo.Models.TimeTable", b =>
                {
                    ...
                    b.Property<int?>("idclassee");

                    b.HasKey("TimeTableId");

                    b.HasIndex("idclassee");
            ...
            modelBuilder.Entity("EFCoreToDo.Models.TimeTable", b =>
                {
                    b.HasOne("EFCoreToDo.Models.Classs", "Classee")
                        .WithMany()
                        .HasForeignKey("idclassee");
                });
